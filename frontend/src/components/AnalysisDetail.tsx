...
const AnalysisDetail = ({ result }: Props) => {
  if (!result) {
    return (
      <div className="w-full mt-[70px] max-w-5xl h-160 md:h-120 max-h-[100vh] md:max-h-[600px] bg-cuswhite rounded-lg shadow-[0px_0px_20px_-12px_rgba(0,0,0,0.3)] flex items-center justify-center">
        <span className="text-cuslightblack text-bs font-semibold animate-pulse">Memuat data...</span>
      </div>
    );
  }
